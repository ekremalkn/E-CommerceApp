...
final class CustomButton: UIButton {
    ...
    convenience init(title: String? = nil, titleColor: UIColor? = nil, font: UIFont? = nil, backgroundColor: UIColor? = nil, cornerRadius: CGFloat? = nil, image: UIImage? = nil, tintColor: UIColor? = nil, imageEdgeInsets: UIEdgeInsets? = nil, titleEdgeInsets: UIEdgeInsets? = nil) {
